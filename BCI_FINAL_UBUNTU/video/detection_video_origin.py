...
def learning(v):
    ...
    invid = os.path.join(dataset_path, "{}".format(videofile))
    outvid = os.path.join(dataset_path+'/video_output', "{}".format(videofile))
    print('outvid:', outvid)

    os.chdir(makedir)
    make_video(invid, images, fps)
    #print(obj_list)
    #print(ratio_list)
        
    FFMPEG = "ffmpeg -i "+invid+" -c:a libfdk_aac -b:a 128k "+outvid
    MOVE = "yes | cp -rf "+outvid+" "+dataset_path+"/videos/" 
